...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"ѕриветствую  ¬ас  в  ¬ашем  Ёл эш";
			// 
			// label2
			// 
			...
			this->button1->Text = L"¬несение / сн€тие денег";
			...
			this->label4->Text = L"ќбщие накоплени€:";
			// 
			// label5
			// 
			...
			this->label6->Text = L"Ѕюджет на мес€ц:";
			// 
			// dataGridView1
			// 
			...
			this->Column1->HeaderText = L"Ќаименование";
			...
			this->Column2->HeaderText = L" ол-во руб.";
			...
			this->label8->Text = L"Ќазвание  цели";
			// 
			// label9
			// 
			...
			this->button3->Text = L"»зменить  цель";
